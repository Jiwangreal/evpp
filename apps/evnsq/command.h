...
public:
    ...
    //
    // After `Identify`, this is usually the first message sent, if auth is
    // used.
    ...
    // UnRegister sets a new Command to remove a topic/channel for the connected
    // nsqd
    ...
    void MultiPublish(const std::string& topic,
