...
public:
    ...
    bool MultiPublish(const std::string& topic,
...
private:
    ...
    void OnPublishResponse(NSQConn* conn,
...
private:
    ...
    enum
    {
        kDefaultHighWaterMark = 1024
    };
    bool hwm_triggered_;  // The flag of high water mark
    HighWaterMarkCallback high_water_mark_fn_;
    size_t high_water_mark_;  // The high water mark for message count. default
                              // value is kDefaultHighWaterMark
};
