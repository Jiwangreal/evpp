...
// for every listening port and we give this thread a name 'listening main
// thread'.
//
...
public:
     ...
     * param private_key_file 私钥文件
     */
    void setPortSSLDefaultOption(bool enable_ssl,
        const char* certificate_chain_file = "",
        const char* private_key_file       = "");
#endif
...
private:
    struct ListenThread
    {
        ...
        // Every listening main thread runs a HTTP Service to listen, receive,
        // dispatch, send response the HTTP request.
