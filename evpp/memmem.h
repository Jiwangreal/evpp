...
// @see
// https://raw.githubusercontent.com/jaysi/jlib/3f7a190e1e80b270c9a07cac46aeab960a802cd1/src/memmem.c
    ...
    size_t needle_len)
{
    ...
    {
        if (__builtin_expect(hash == hay_hash, 0) && *haystack_ == *needle_
            && /* prevent calling memcmp, was a optimization from existing glibc
                */
