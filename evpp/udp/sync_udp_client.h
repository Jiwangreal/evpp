...
public:
    ...
    //! brief : Do a udp request and wait for remote udp server send response
    //! data param[in] - const std::string & udp_package_data return -
    //! std::string the response data
    ...
    static bool Send(const char* msg,
        size_t len,
