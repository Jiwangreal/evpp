...
public:
    ...
    //  Do a HTTP GET request if body is empty or HTTP POST request if body is
    //  not empty.
    // @param[in] pool -
    // @param[in] loop -
    ...
    // @param[in] body -
    // @return  -
    Request(ConnPool* pool,
        EventLoop* loop,
        const std::string& uri_with_param,
