...
#define LOG_TRACE LOG(INFO) << "[TRACE] " << __FILE__ << ":" << __LINE__ << " "
#define LOG_DEBUG LOG(INFO) << "[DEBUG] " << __FILE__ << ":" << __LINE__ << " "
#define LOG_INFO LOG(INFO) << "[INFO] " << __FILE__ << ":" << __LINE__ << " "
#define DLOG_TRACE LOG(INFO) << "[DLOG_TRACE] " << __PRETTY_FUNCTION__ << " "
#else
#define LOG_TRACE                                                              \
  if (false)                                                                   \
  LOG(INFO)
